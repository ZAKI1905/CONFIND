...
{
#if PROFILING
    Zaki::Util::Instrumentor::BeginSession("2_MemFunctionOptimized", "examples/2_MemberFunction_Optimized/2_MemFunctionOptimized_Profile.json") ;
#endif
    // ...........................
    // Setting up the grid
    // ...........................
    ...
    char tmp[75] ;
    sprintf(tmp, "%s", "examples/2_MemberFunction_Optimized") ;
    con.SetWrkDir(tmp) ;
    ...
    con.Plot("2_MemFunctionOptimized", "Member Function (Optimized)", "X", "Y") ;
